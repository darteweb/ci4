...
<footer>
<div class="preload_area" style="display:none;"><img src="<?php echo base_url();?>/public/images/default.svg"></div>
...
<li><img src="<?php echo base_url();?>/public/images/browser/edge_icon.png" class="img-responsive" title="Edge"><span>Edge</span></li>
<li><img src="<?php echo base_url();?>/public/images/browser/ch_icon.png" class="img-responsive" title="Google Chrome"><span>Chrome</span></li>
<li><img src="<?php echo base_url();?>/public/images/browser/ff_icon.png" class="img-responsive" title="Fire Fox"><span>Fire Fox</span></li>
<li class="saf-icon"><img src="<?php echo base_url();?>/public/images/browser/saf_icon.png" class="img-responsive" title="Safari"><span>Safari</span></li>
</ul>
    </div>
</div>
</div>
