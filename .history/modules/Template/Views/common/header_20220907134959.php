...
<title>IIM</title>
<!--favicon icon-->
<link rel="shortcut icon" href="<?php echo base_url();?>/public/images/favicon.ico" type="" />
<!--Jquery Library-->
...
<!--Date Time picker js-->
<script type='text/javascript' src="<?php echo base_url();?>/public/js/custom-js.js"></script>  
<!--Custom js-->
...
<script type='text/javascript' src="<?php echo base_url();?>/public/js/jobs-script.js"></script> 
</head>
<body>
<div class="container">
...
<div class="logo-iimt">    
<a href="" title="IIM">
<img src="<?php echo base_url();?>/public/images/iimt-logo.png" class="img-responsive" title="Indian Institute Of Management" />
<!--<h2>IIM</h2>-->
</a>
</div>
</div>
...
<div class="innertitle"><h3 class="tag_line_home">Indian Institute of Management</h3></div>
<div style="clear:both"></div>
<div class="innertitle"><h3 class="tag_line_home">Application</h3></div>
</div>
